...
from alcics.utils.common import unlist
...
class HALAuthor(DBAuthor):
    ...
    def query_id(self, s=None):
        ...
        >>> laurent.query_id()
        [HALAuthor(name='Laurent Viennot', id='laurentviennot'), HALAuthor(name='Laurent Viennot', pid=1344543)]
    ...
    def query_publications(self, s=None):
        ...
        'type': 'conference', 'year': 2008, 'url': 'https://inria.hal.science/inria-00471724',
        ...
        HALAuthor(name='Fabien de Montgolfier', pid=949013),
        ...
        'type': 'conference', 'year': 2007, 'url': 'https://inria.hal.science/hal-00668356',
